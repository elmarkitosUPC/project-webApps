...
export default async function Leaderboard_Snake() {
                ...
                <div className="container mx-auto">
                    <div className="space-y-6">
                        <div className="text-center">
                            <h2 className="text-3xl font-bold text-gray-900 dark:text-black">Global Snake Game Leaderboard</h2>
                            <p className="text-gray-500 dark:text-gray-400 mt-2">Discover the best Snake Game players worldwide.</p>
                        </div>
