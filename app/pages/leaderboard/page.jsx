...
export default async function Page_Leaderboard() {
    return (
        <div className="flex flex-col min-h-screen">
            <section className="container mx-auto mt-12">
                <h2 className="text-2xl font-bold mb-4">Select the Game for the Leaderboard</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                    <Link href="/pages/leaderboard/snake" className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow" prefetch={false}>
                        <div className="p-4">
                            <Image
                    ...
                    <Link href="/pages/leaderboard/minesweeper" className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow" prefetch={false}>
                        <div className="p-4">
                            <Image
                    ...
                    <Link href="/pages/leaderboard/tictactoe" className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow" prefetch={false}>
                        <div className="p-4">
                            <Image
