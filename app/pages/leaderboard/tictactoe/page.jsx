...
export default async function Leaderboard_TicTacToe() {
                ...
                <div className="container mx-auto">
                    <div className="space-y-6">
                        <div className="text-center">
                            <h2 className="text-3xl font-bold text-gray-900 dark:text-black">Global Tic Tac Toe Leaderboard</h2>
                            <p className="text-gray-500 dark:text-gray-400 mt-2">Discover the best Tic Tac Toe players worldwide.</p>
                        </div>
